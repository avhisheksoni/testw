    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item">Sales Edit Form</li>
            ...
            <div class="row">
              ...
              <div class="col-lg-5">
                ...
                <div class="col-lg-4">
                   <div class="form-group">
                    <label for="cheque_received_amount">Cheque Amount</label>
                    <input class="form-control pro adamount" id="cheque_received_amount{{ $s_no }}" name="cheque_received_amount_[]" type="text" value="{{ $cmaot->cheque_amount }}" aria-describedby="emailHelp" placeholder="cheque received amount">
              ...
              <div class="col-lg-4">
                 <div class="form-group">
                    ...
                    <input class="form-control gross pro newpro" id="other" name="other"  type="number" aria-describedby="emailHelp" value="{{ $edit->other }}" placeholder="Enter other">
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
