            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                 <div class="form-group">
                    ...
                    <input class="form-control gross pro newpro" id="other" name="other"  type="number" aria-describedby="emailHelp" value="{{ old('other')}}" placeholder="Enter other">
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
              ...
              <div class="col-lg-4">
                 <div class="form-group">
                    <label for="other">Total Order Value</label>
                    <input class="form-control gross pro newpro" id="other" name="other"  type="number" aria-describedby="emailHelp" value="{{ old('other')}}" placeholder="Enter other">
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
                    <label for="five_percrnt_sd">Total Balance Left</label>
                    <input class="form-control" id="five_percrnt_sd" name="five_percrnt_sd" type="text" aria-describedby="emailHelp" value="{{ old('five_percrnt_sd')}}" placeholder="Fixed Deposite Rate">
                     @error('five_percrnt_sd')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-lg-4">
                   <div class="form-group">
                    <label for="tds_amount">Other 1</label>
                    <input class="form-control pro" id="five_percrnt_sd_amount" type="text" aria-describedby="emailHelp" value="{{ old('five_percrnt_sd_amount')}}" name="five_percrnt_sd_amount" placeholder="sd amount cal">
                  </div>
                </div>
              </div>
...
$(document).ready(function(){
 ...
 // }
  ...
  $(document).on('click', '.btn_remove', function(){
    ...
    $("#outstanding").css("background-color","");
  }else{
    $('#row'+button_id+'').remove();
    $("#outstanding").css("background-color","");
  }
 ...
 $("#job_id").on("change",function(){
     ...
     $(document).on("blur",".adamount,.newpro", function(){
      ...
      //if(finalout >= 0 ){
          ...
          $("#outstanding").val(outs);
          $("#outstanding").css("background-color", "#ff6666");
           }
          $("#tds_amount").val("");
          $("#tds_amount").val(tdsam);
          $("#five_percrnt_sd_amount").val("");
