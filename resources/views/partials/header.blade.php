...
input[type=number] {
  -moz-appearance: textfield;
    ...
    <script type="text/javascript" src="https://checkout.tabby.ai/integration.js"></script>
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        @role('superadmin','admin'){{-- @role(['acco_super_admin','acco_admin']) --}}
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">ACL</span><i class="treeview-indicator fa fa-angle-right"></i></a>
         ...
         <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Request Approvals</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="{{ route('guarantee-approval-list') }}" target="" rel="noopener"><i class="icon fa fa-circle-o"></i>Guarantee Approval</a></li>
            <li><a class="treeview-item" href="{{ route('permissionlist') }}"><i class="icon fa fa-circle-o"></i>Permission</a></li>
          </ul>
        </li>
        @endrole
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Reconcilation-Form</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="{{ route('saleform') }}"><i class="icon fa fa-circle-o"></i>Sales Form</a></li>
            @endpermission
            <li><a class="treeview-item" href="{{ route('salelist')}}" target="" rel="noopener"><i class="icon fa fa-circle-o"></i>Sale List</a></li>
            <li><a class="treeview-item" href="{{ route('purchaseform') }}"><i class="icon fa fa-circle-o"></i>Purchase Form</a></li>
            <li><a class="treeview-item" href="{{ route('purchaselist') }}"><i class="icon fa fa-circle-o"></i> Purchase List</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Bank Guarantee</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="{{ route('beneficiary-request-list') }}"><i class="icon fa fa-circle-o"></i> Request</a></li>
            <li><a class="treeview-item" href="{{  route('guarantee-list') }}"><i class="icon fa fa-circle-o"></i>Guarantee</a></li>
            <li><a class="treeview-item" href="{{  route('Guarantee-type-list') }}"><i class="icon fa fa-circle-o"></i>Type</a></li>
            <li><a class="treeview-item" href="{{ route('benef-list') }}"><i class="icon fa fa-circle-o"></i>Beneficiary Add</a></li>
          </ul>
        </li>
        {{--  <li class="treeview"><a class="app-menu__item" href="{{ route('master-page')}}" data-toggle=""><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Masters</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        </li> --}}
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Master</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="{{ route('assign-client-list')}}"><i class="icon fa fa-circle-o"></i>Assign Company</a></li>
            ...
            <li><a class="treeview-item" href="{{route('Passingn.index')}}"><i class="icon fa fa-circle-o"></i>P-assign Receiver</a></li>
          </ul>
        </li>
         <li><a class="app-menu__item" href="{{ route('due_amount_list') }}"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Due Amount</span></a></li>
          <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Pages</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{ route('payment') }}"><i class="icon fa fa-circle-o"></i> Blank Page</a></li>
