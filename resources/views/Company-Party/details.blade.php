            ...
            <div class="tile-body">
              <form class="form-horizontal">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="company_party" value="{{ $edit->company_party }}" placeholder="Enter Company name" readonly>
                     @error('company_party')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="party_code" value="{{ $edit->party_code }}" placeholder="Enter Company name" readonly>
                     @error('party_code')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="number" name="code_gen" value="{{ $edit->code_gen }}" placeholder="Enter Company name" readonly>
                     @error('code_gen')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
