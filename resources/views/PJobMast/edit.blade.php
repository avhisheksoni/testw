...
@section('content')
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>P-Job/Work Name Update</h1>
          <p>P-Job/Work Update</p>
        </div>
              ...
              <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="gsstin_uin_of_recipient" name="gsstin_uin_of_recipient" value="{{ $edit->Pclient->gstin }}" type="text" aria-describedby="emailHelp" placeholder="choose receiver"  readonly="" >
