      ...
      (() => {
        ...
        var payment = {
          ...
          buyer: {
            ...
            name: 'John Doe',
            phone: '+971500000001', // +97150000000 for UAE, +96650000000  for Saudi Arabia, +96590000001 for Kuwait, +97366900001 for Bahrain
          },
          buyer_history: {
            loyalty_level: 10,
        ...
        // console.log(selectedTabbyProduct);
        ...
        var config = {
            merchantCode: 'HKSA', // OPTIONAL, USED WHEN A MERCHANT HAS MORE THAN ONE STORE, PLEASE CONTACT YOUR INTEGRATION MANAGER
           // sessionId: 'EXISTING_SESSION_ID', // OPTIONAL
           // OPTIONAL URLs, required only for Kuwait and Bahrain integration
           // merchantUrls: {
          ...
          apiKey: 'pk_test_b0b63b33-599e-41fd-b085-8c251f2a7319',
...
// https://docs.tabby.ai/#section/Testing-Guidelines
